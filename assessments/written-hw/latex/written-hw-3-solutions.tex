...
Engineers} (5th ed., Global Edition), Chapter 23. $\dfrac{1}{4\pi\varepsilon_0} =
...
\[
E_A = E_B = \frac{1}{4\pi\varepsilon_0}\frac{|q|}{r^2} =
\frac{(8.99\times10^{9})(3.0\times10^{-9})}{(0.0707\text{
...
\[
E_A = \frac{1}{4\pi\varepsilon_0}\frac{q_A}{r_A^2} =
\frac{(8.99\times10^{9})(3.0\times10^{-9})}{(0.050)^2} =
...
\[
E_B = \frac{1}{4\pi\varepsilon_0}\frac{|q_B|}{r_B^2} =
\frac{(8.99\times10^{9})(6.0\times10^{-9})}{(0.1118)^2} =
...
\[
E_{\text{rod}}(y) = \frac{1}{4\pi\varepsilon_0}\frac{Q}{y\sqrt{y^2+(L/2)^2}},
\]
...
$E=\dfrac{1}{4\pi\varepsilon_0}Q_{\text{rod}}\big/\big(y\sqrt{y^2+(L/2)^2}\big)$. The force
on the bead is $F=qE$.}
...
\[
Q_{\text{rod}} = \frac{Ey\sqrt{y^2+(L/2)^2}}{1/(4\pi\varepsilon_0)} =
...
charge, $E = \lambda/(2\pi\varepsilon_0 r)$, independent of the wire's total length.}
...
\[
\lambda = 2\pi\varepsilon_0 Er = 2\pi(8.85\times10^{-12})(1000\text{ N/C})(0.020\text{ m}) =
