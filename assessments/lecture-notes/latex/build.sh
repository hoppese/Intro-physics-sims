...
# into assessments/lecture-notes/, where the rest of the lecture-note PDFs
# live. Usage:
#   ./build.sh                     # build every *-notes.tex file
#   ./build.sh gauss-applications-notes   # build just one (name, no .tex)
set -euo pipefail
cd "$(dirname "$0")"
