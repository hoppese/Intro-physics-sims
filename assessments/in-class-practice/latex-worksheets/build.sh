#!/bin/bash
# Compile every worksheet .tex in this folder and copy the finished PDF up
# into assessments/in-class-practice/, where the rest of the practice PDFs
# live. Usage:
#   ./build.sh                     # build every *-practice.tex file
#   ./build.sh coulomb-force-practice   # build just one (name, no .tex)
set -euo pipefail
cd "$(dirname "$0")"
